          ...
          <div className="w-80 mb-4">
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="text-right">
                <span className="block">BTCPay Server</span>
                <span className="block font-bold">0.0000010 BTC</span>
                <span className="block text-sm">1 BTC = $500000 (USD)</span>
              </div>
            </div>
